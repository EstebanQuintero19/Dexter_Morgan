...
export const KILLERS = [
  { s: 1, label: 'B.M.', date: '12·06', name: 'Brian Moser', role: 'The Ice Truck Killer. His brother.',
  ...
  { s: 2, label: 'L.W.', date: '—', name: 'Lila West', role: 'The one who wanted to see the real him.', empty: true,
    quote: "I'm the one who sees you.", who: 'Lila',
    end: 'A knife in Paris. No slide. He did not want to keep her.' },
  { s: 3, label: 'M.P.', date: '12·08', name: 'Miguel Prado', role: 'The friend who learned the code and used it wrong.',
  ...
  { s: 4, label: 'A.M.', date: '12·09', name: 'Arthur Mitchell', role: 'Trinity. The family man.',
  ...
  { s: 5, label: 'J.C.', date: '12·10', name: 'Jordan Chase', role: 'The motivational speaker. Take it.',
    quote: "Tick, tick, tick. That's the sound of your life running out.", who: 'Jordan',
    end: 'Dexter stepped back. Lumen took him herself.' },
  { s: 6, label: 'T.M.', date: '12·11', name: 'Travis Marshall', role: 'The Doomsday Killer.',
    quote: "It's the end of the world.", who: 'Travis',
    end: 'Knife to the chest. Deb opened the door. “Oh, God.”' },
  { s: 7, label: 'I.S.', date: '—', name: 'Isaak Sirko', role: 'The Koshka brotherhood. The one who understood.',
  ...
  { s: 8, label: 'O.S.', date: '09·13', name: 'Oliver Saxon', role: 'The Brain Surgeon. Vogel’s son.',
